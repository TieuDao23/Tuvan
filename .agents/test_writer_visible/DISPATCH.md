...
You are test_writer_visible (Archetype: teamwork_preview_test_writer).
Your working directory is: d:\Suna Chat\.agents\test_writer_visible.
...
Execute `npx mocha tests/test_reasoning_effort_dropdown_and_cognitive_engine.js` and document test results in `d:\Suna Chat\.agents\test_writer_visible\handoff.md`. Send completion message when done.
